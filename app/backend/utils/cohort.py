"""
Utility functions for cohort data transformation and manipulation.
"""
...
def transform_cohort_for_ui(cohort: Dict) -> Dict:
    ...
    if "phenotypes" in result and result["phenotypes"]:
        result["phenotypes"] = [
            transform_phenotype_for_ui(p) for p in result["phenotypes"]
        ]
    ...
    for category in [
        ...
        if category in result:
            if category == "entry_criterion" and result[category]:
                ...
                result[category] = [
                    transform_phenotype_for_ui(p) for p in result[category]
                ]
