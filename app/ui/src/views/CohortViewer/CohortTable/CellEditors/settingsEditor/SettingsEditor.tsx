...
export const SettingsEditor: React.FC<SettingsEditorProps> = props => {
  ...
  const createDeleteButton = () => {
    return (
      <div className={`${styles.settingSection}`} onClick={() => deletePhenotype()}>
        <div className={styles.settingName}>Delete</div>
        <p className={styles.settingInfo}>
          Permanently delete the {props.data.type} phenotype{' '}
          <span className={styles.emph}>"{props.data.name}"</span>. This will remove it from the
          cohort and cannot be undone.
        </p>
      </div>
    );
  };
  ...
  const createDuplicateButton = () => {
    return (
      ...
      >
        ...
        <p className={styles.settingInfo}>
          Duplicate <span className={styles.emph}>"{props.data.name}"</span> within the cohort.
        </p>
      </div>
    );
  };
  ...
  const createCopyButton = () => {
    return (
      ...
      >
        ...
        <p className={styles.settingInfo}>
          Copy <span className={styles.emph}>"{props.data.name}"</span> to the clipboard. You can
          then paste into other cohorts.
        </p>
      </div>
    );
  };
  ...
  const createExecuteButton = () => {
    return (
      ...
      >
        ...
        <p className={styles.settingInfo}>
          Execute <span className={styles.emph}>"{props.data.name}"</span> only. This will execute
          the phenotype and update the cohort.
        </p>
      </div>
    );
  };
