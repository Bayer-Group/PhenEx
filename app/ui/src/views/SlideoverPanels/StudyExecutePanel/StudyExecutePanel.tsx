    ...
    <div className={styles.container}>
      ...
      <div className={styles.scrollableWrapper}>
        <div ref={contentScrollRef} className={styles.scrollableContent}>
          {renderContent()}
            <span>This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. This iis very long text to test the scrolling of the log viewer. It should wrap and be scrollable if it exceeds the width of the container. Let's add some more text to make sure it really does exceed the width. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
