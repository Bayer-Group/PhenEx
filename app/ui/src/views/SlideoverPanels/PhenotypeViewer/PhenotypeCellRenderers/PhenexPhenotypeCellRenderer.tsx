...
export const PhenexPhenotypeCellRenderer: React.FC<PhenexPhenotypeCellRendererProps> = props => {
  ...
  const renderParameterMissingCell = () => {
    ...
    return (
    <PhenexCellRenderer {...props} colorBackground={true} colorBorder={false} showButtons={false} justify="left">
      <div 
        style={{ 
          fontSize: '18px', 
          fontStyle: 'italic', 
  ...
  if (props.data?.parameter in classNameToRendererMapping) {
    ...
    return <Renderer {...props} fontSize={'18px'} colorBackground={true} colorBorder={false} showButtons={false} justify="left"/>;
  }
