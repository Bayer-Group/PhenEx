      ...
      {isVisible ? (
        <img
          ...
          style={{
            ...
            height: '16px',
            filter:
              'brightness(0) saturate(100%) invert(27%) sepia(82%) saturate(2526%) hue-rotate(200deg) brightness(97%) contrast(102%)', // Blue color
          }}
        />
      ) : (
        <img
          ...
          style={{
            ...
            height: '16px',
            filter:
              'brightness(0) saturate(100%) invert(60%) sepia(0%) saturate(0%) hue-rotate(0deg) brightness(106%) contrast(92%)', // Gray color
          }}
        />
      )}
    </div>
