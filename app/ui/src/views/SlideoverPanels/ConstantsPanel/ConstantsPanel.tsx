...
export const ConstantsPanel: React.FC = () => {
      ...
      <span>
        ...
        <ul>
          <li>
            ...
            defaults can be edited here.
          </li>
          <li>Create a constant if you find yourself defining the same variable more than once</li>
          <li>
            Using constants, any changes you make here apply to any phenotype using the constant
          </li>
        ...
        <ol>
          ...
          <li>
            ...
            want to define i.e. whether it is a date filter or categorical filter.
          </li>
          <li>
            <em>Edit constants in the table</em> : click on the value column to open an editor; edit
            parameters there.
          </li>
          <li>
            <em>Use the constants</em> : constants are available in the phenotype editing area.
          </li>
        </ol>
      </span>
    );
  ...
  return (
    <SlideoverPanel title="Constants" info={infoContent()}>
