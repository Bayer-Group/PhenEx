        ...
        return pd.DataFrame(
            {
                ...
                "OPERATOR_CONCEPT_ID": pd.array(operator_concept_ids, dtype="Int64"),
                "VALUE_AS_NUMBER": pd.array(value_as_numbers, dtype="Float64"),
                "VALUE_AS_CONCEPT_ID": pd.array(value_as_concept_ids, dtype="Int64"),
                "UNIT_CONCEPT_ID": pd.array(unit_concept_ids, dtype="Int64"),
                "RANGE_LOW": pd.array(range_lows, dtype="Float64"),
                "RANGE_HIGH": pd.array(range_highs, dtype="Float64"),
                "PROVIDER_ID": pd.array(provider_ids, dtype="Int64"),
                "VISIT_OCCURRENCE_ID": pd.array(visit_occurrence_ids, dtype="Int64"),
                "VISIT_DETAIL_ID": pd.array(visit_detail_ids, dtype="Int64"),
                "MEASUREMENT_SOURCE_VALUE": measurement_source_values,
                "MEASUREMENT_SOURCE_CONCEPT_ID": pd.array(
                    measurement_source_concept_ids, dtype="Int64"
                ),
                "UNIT_SOURCE_VALUE": unit_source_values,
