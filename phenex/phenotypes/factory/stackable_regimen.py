...
class StackableRegimen:
    def __init__(
        ...
        Parameters:
            ...
            name: Prefix added to every stackable regimen. Format of output phenotype names is {name}_{stackN}_{phenotypename1}_{phenotype2}

        Attributes:
            output_phenotypes: List of phenotypes generated by the regimen
            output_phenotypes_dict: Dictionary mapping stack sizes to lists of phenotypes
