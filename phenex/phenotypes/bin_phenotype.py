...
class BinPhenotype(Phenotype):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.phenotype.__class__.__name__ not in ["AgePhenotype", "MeasurementPhenotype", "ArithmeticPhenotype", "ScorePhenotype"]:
            raise ValueError(f"Invalid phenotype type: {self.phenotype.__class__.__name__}")
