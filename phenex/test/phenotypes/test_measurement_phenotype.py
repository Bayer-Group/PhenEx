...
class MeasurementPhenotypeValueAggregationTestGenerator(PhenotypeTestGenerator):
    name_space = "mmpt_valueaggregation"
    test_values = True
...
if __name__ == "__main__":
    ...
    test_measurement_phenotype_value_aggregation()
