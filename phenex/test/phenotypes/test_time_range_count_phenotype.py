...
class TimeRangeCountPhenotypeTestGenerator(PhenotypeTestGenerator):
    ...
    def define_input_tables(self):
        ...
        p1_data = [
            {"PERSON_ID": "P1", "START_DATE": index_date - 30*oneday, "END_DATE": index_date - 25*oneday},
            {"PERSON_ID": "P1", "START_DATE": index_date + 10*oneday, "END_DATE": index_date + 15*oneday},
            {"PERSON_ID": "P1", "START_DATE": index_date + 60*oneday, "END_DATE": index_date + 65*oneday},
        ]
        
        # Person P2: 2 visits, both after index
        p2_data = [
            {"PERSON_ID": "P2", "START_DATE": index_date + 5*oneday, "END_DATE": index_date + 10*oneday},
            {"PERSON_ID": "P2", "START_DATE": index_date + 50*oneday, "END_DATE": index_date + 55*oneday},
        ]
        
        # Person P3: 4 visits, 2 before index, 2 after index
        p3_data = [
            {"PERSON_ID": "P3", "START_DATE": index_date - 60*oneday, "END_DATE": index_date - 55*oneday},
            {"PERSON_ID": "P3", "START_DATE": index_date - 30*oneday, "END_DATE": index_date - 25*oneday},
            {"PERSON_ID": "P3", "START_DATE": index_date + 15*oneday, "END_DATE": index_date + 20*oneday},
            {"PERSON_ID": "P3", "START_DATE": index_date + 90*oneday, "END_DATE": index_date + 95*oneday},
        ]
        
        # Person P4: 1 visit, overlapping index date (should be excluded from before/after counts)
        p4_data = [
            {"PERSON_ID": "P4", "START_DATE": index_date - 5*oneday, "END_DATE": index_date + 5*oneday},
        ]
        ...
        p6_data = [
            {"PERSON_ID": "P6", "START_DATE": index_date + 10*oneday, "END_DATE": index_date + 12*oneday},
            {"PERSON_ID": "P6", "START_DATE": index_date + 20*oneday, "END_DATE": index_date + 22*oneday},
            {"PERSON_ID": "P6", "START_DATE": index_date + 30*oneday, "END_DATE": index_date + 32*oneday},
            {"PERSON_ID": "P6", "START_DATE": index_date + 40*oneday, "END_DATE": index_date + 42*oneday},
            {"PERSON_ID": "P6", "START_DATE": index_date + 50*oneday, "END_DATE": index_date + 52*oneday},
        ]
        ...
        df_index = pd.DataFrame({
            ...
            "INDEX_DATE": [index_date] * len(all_persons)
        })
    ...
    def define_phenotype_tests(self):
        ...
        t4["phenotype"] = TimeRangeCountPhenotype(
            ...
            relative_time_range=RelativeTimeRangeFilter(
                when="after", max_days=LessThanOrEqualTo(52) # lies directly after P6 end date and in the middle of P2 end date i.e. check that P6 remains while P2 events removed. additionally fully excludes P3 start date.
            ),
        )
        ...
        t5["phenotype"] = TimeRangeCountPhenotype(
            ...
            domain="VISIT_OCCURRENCE",
            relative_time_range=RelativeTimeRangeFilter(
                when="after", min_days=GreaterThanOrEqualTo(9) # lies directly before P1 start. excludes P2  start date, 
            ),
        )
        ...
        t6["phenotype"] = TimeRangeCountPhenotype(
            ...
            value_filter=ValueFilter(
                min_value=GreaterThan(1), 
                max_value=LessThanOrEqualTo(2)
            )
        )
...
class TimeRangeCountWithAnchorPhenotypeTestGenerator(PhenotypeTestGenerator):
    ...
    def define_input_tables(self):
        ...
        visit_data = [
            ...
            {"PERSON_ID": "P2", "START_DATE": index_date + 20*oneday, "END_DATE": index_date + 25*oneday},
            {"PERSON_ID": "P2", "START_DATE": index_date + 80*oneday, "END_DATE": index_date + 85*oneday},
            
            # P3: 1 visit before anchor
            {"PERSON_ID": "P3", "START_DATE": index_date - 45*oneday, "END_DATE": index_date - 40*oneday},
        ]
...
class TimeRangeCountWithDaysFilterTestGenerator(PhenotypeTestGenerator):
    ...
    def define_input_tables(self):
        ...
        visit_data = [
            ...
            {"PERSON_ID": "P1", "START_DATE": index_date + 5*oneday, "END_DATE": index_date + 7*oneday},      # 5 days after
            {"PERSON_ID": "P1", "START_DATE": index_date + 15*oneday, "END_DATE": index_date + 17*oneday},    # 15 days after  
            {"PERSON_ID": "P1", "START_DATE": index_date + 45*oneday, "END_DATE": index_date + 47*oneday},    # 45 days after
            {"PERSON_ID": "P1", "START_DATE": index_date + 120*oneday, "END_DATE": index_date + 122*oneday},  # 120 days after
            
            # P2: visits within 30 days after index
            {"PERSON_ID": "P2", "START_DATE": index_date + 10*oneday, "END_DATE": index_date + 12*oneday},    # 10 days after
            {"PERSON_ID": "P2", "START_DATE": index_date + 25*oneday, "END_DATE": index_date + 27*oneday},    # 25 days after
        ]
