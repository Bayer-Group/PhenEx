...
from phenex.phenotypes.factory.one_inpatient_two_outpatient import OneInpatientTwoOutpatientPhenotype
...
def build_fake_condition_data():
    fake_data = [
        {"PERSON_ID": "P1", "EVENT_DATE": datetime.date(2021, 10, 10),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "inpatient"},
        {"PERSON_ID": "P1", "EVENT_DATE": datetime.date(2021, 10, 11),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "outpatient"},
        {"PERSON_ID": "P1", "EVENT_DATE": datetime.date(2021, 10, 12),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "outpatient"},

        {"PERSON_ID": "P2", "EVENT_DATE": datetime.date(2021, 9, 5),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "outpatient"},
        {"PERSON_ID": "P2", "EVENT_DATE": datetime.date(2021, 9, 20),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "outpatient"},

        {"PERSON_ID": "P3", "EVENT_DATE": datetime.date(2021, 8, 2),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "inpatient"},
        {"PERSON_ID": "P3", "EVENT_DATE": datetime.date(2021, 8, 15),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "outpatient"},

        {"PERSON_ID": "P4", "EVENT_DATE": datetime.date(2021, 7, 10),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "inpatient"},

        {"PERSON_ID": "P5", "EVENT_DATE": datetime.date(2021, 6, 10),
         "CODE": "C1", "CODE_TYPE": "ICD10", "ENCOUNTER_TYPE": "outpatient"},
    ]
