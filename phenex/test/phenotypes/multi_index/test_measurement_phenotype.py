...
class MultiIndexMeasurementPhenotypeRelativeTimeRangeTestGenerator(
    ...
    def define_input_tables(self):
        tables = MeasurementPhenotypeRelativeTimeRangeFilterTestGenerator.define_input_tables(self)
        return self._duplicate_input_tables(tables)

    def define_phenotype_tests(self):
        tests = MeasurementPhenotypeRelativeTimeRangeFilterTestGenerator.define_phenotype_tests(self)
