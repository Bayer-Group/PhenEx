...
from phenex.phenotypes.time_range_days_to_next_range_phenotype import (
...
class TimeRangeDaysToNextRangePhenotypeTestGenerator(PhenotypeTestGenerator):
    ...
    def define_input_tables(self) -> List[Dict]:
        ...
        visit_data = [
            ...
            {
                "PERSON_ID": "P2",
                "START_DATE": p2_next_start_1,
                "END_DATE": p2_next_end_1,
            },
            {
                "PERSON_ID": "P2",
                "START_DATE": p2_next_start_2,
                "END_DATE": p2_next_end_2,
            },
            # P3
    ...
    def define_phenotype_tests(self):
        ...
        t2 = {
            ...
            "phenotype": TimeRangeDaysToNextRange(
                ...
                domain="VISIT_OCCURRENCE",
                relative_time_range=RelativeTimeRangeFilter(when="after"),
                value_filter=ValueFilter(min_value=GreaterThan(15)),
            ),
            "persons": ["P2"],
            "values": [20],
            "dates": [p2_next_start],
